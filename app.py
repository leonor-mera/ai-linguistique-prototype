...
st.set_page_config(page_title="AI Linguistique - Sélection sécurisée", layout="centered")
st.title("🎙️ AI Linguistique - Entraînement à la prononciation avec protection d'état")

st.markdown("Parlez depuis votre navigateur, sélectionnez votre micro, et recevez une évaluation immédiate.")
...
# Verificar la sesión antes de acceder a sus claves
