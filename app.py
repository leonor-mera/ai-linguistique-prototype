...
st.set_page_config(page_title="AI Linguistique - Feedback Prononciation", layout="centered")
st.title("🎙️ AI Linguistique - Entraînement à la prononciation en direct")

st.markdown("Parlez depuis votre navigateur, écoutez la phrase modèle, et recevez un retour immédiat sur votre prononciation.")
